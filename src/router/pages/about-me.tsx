...
export const AboutMe = () => {
    ...
    return (
        ...
        >   
            ...
            <Box width="100%" height={{min:"300px"}} direction="row" pad={{top:"large"}}>
                <Box width="50%" background="brand" align="center" justify="center" pad={{left:"large"}}>
                    <Heading textAlign="start" level={2}>
                        Full Stack Software Developer + Freelance Digital Artist <br/>By Day
                    </Heading>
                </Box>
                <Box width="50%" height={{min:"300px"}} pad={{right:"large"}} justify="center">
                    <Heading level={2} textAlign="end">
                        Functional Fitness Coach + <br/>Stretchy Pant Consultant <br/>By Night
                    </Heading>
                </Box>
            </Box>
...
const BottomButtons = () => {
    ...
    return (
    <Box width="100%" direction="row" justify="between" style={{opacity:"0.5"}}>
        ...
        <Box width="max-content" height="20%" pad="medium">
            <Button onClick={()=>{window.scrollTo(0,0)}} color="none" plain>
                to the top &uarr;
            </Button>
        </Box>
...
const Bio = ({ ...props}: TextProps) => (
    <Text {...props}>
        I majored in Computer Science at the University of Manitoba where I graduated in 2017
        <br/>
        I run a small business creating custom digital art <A href={instagram}>@designbyrea</A> <br/>
        I freelance graphic design from time-to-time <br/>
        My full time gig is as a developer at <A href="http://sightlineinnovation.com">Sightline Innovation Inc.</A><br/>
        I'm a Level 2 CrossFit Trainer at <A href="https://norakcrossfit.com/">CrossFit Norak </A>in Winnipeg, MB <br/>
        And when I'm not doing those things,<br/> I'm training my girl Millie over there to be a therapy dog!
    </Text>
)
